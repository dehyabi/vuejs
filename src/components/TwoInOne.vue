<template>
  <div
    class="container mx-auto px-5 lg:px-20 h-[100vh] md:h-[80vh] flex-col-reverse md:flex-row flex justify-center md:justify-between items-center gap-10"
  >
    ...
    <div class="cat">
      <img :src="imgsrc" alt="cat-img" class="w-[100%] h-[100%] mt-5" />
    </div>
  </div>
</template>
